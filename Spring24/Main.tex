...
\section{Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    ...
    \textbf{Soft Skills:}{ Problem-Solving, Verbal and Written Communication, Leadership, Critical Thinking, Prompt Engineering} \\
     ...
     \textbf{Tools \& Frameworks:}{ TypeScript, jQuery, Node.js, React.js, Express.js, EJS, Passport.js, Bootstrap, \\ Machine Learning, Git,  Internet Computer Protocol(ICP) } \\
...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{\textbf{New American University Scholar :} Awarded with \$62,000 worth of scholarships}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Implemented real-time order management and inventory tracking, boosting client's productivity by 26.3\%}

...
Computer Science student with strong problem-solving and leadership skills, \textbf{experienced in MERN stack web development, AI/ML, and project management}. Built diverse projects ranging from browser extensions to chatbots, \textbf{seeking opportunities to leverage technical expertise and innovation}
...
\resumeItemListEnd
          ...
          \resumeItemListStart
            \resumeItem{Collaborated with the department of CSE at Manipal Institute of Technology (MAHE-MIT) to conduct and publish a research manuscript in the International Research Journal of Engineering and Technology (IRJET), \textbf{enhancing healthcare efficiency in predicting SARS-CoV-2(COVID-19) virus by 58\%}}
